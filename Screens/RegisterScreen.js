...
import {View, StyleSheet, Text, Image, TextInput, CheckBox, TouchableOpacity } from 'react-native';
    ...
    <View style={styles.root}>
      <View style={styles.content}>
          <View style={styles.topSection}>
            ...
            <View>
                <Text style={styles.heading}>Join us to start searching</Text>
          ...
          <View style={styles.inputs}>
            ...
            title="Login"
            style={styles.button}>
              <Text style={styles.loginTexts}>Sign up</Text>
            </TouchableOpacity>
      ...
      <TouchableOpacity onPress={ ()=> props.navigation.navigate('Login') } style={{ position: 'absolute', alignSelf: 'center', bottom: 10 }}><Text style={{ color: '#db153c', textAlign: 'center', padding: 10 }}>have an account? Log in</Text></TouchableOpacity>
    </View>
  );
}
